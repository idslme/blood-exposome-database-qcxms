...
# ╟────────────────────────────────────────────────────────────────╢
# ║ Script      : run_protomer_C.py                                ║
# ║ Description : Execute QCxMS production runs for C-protomers    ║
...
# Define parameter set (C protomer only)
...
for folder in C_parameter_options:
